...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-[#e8f5e9] flex items-center justify-center p-4 bg-[url('/assets/bg.png')]">
      <Card className="w-full max-w-md shadow-md bg-[#e8f5e9]">
        <CardContent className="p-8">
          {/* Title */}
          <h1 className="text-2xl font-bold text-green-800 mb-1">Sign in</h1>
          ...
          <div className="mb-4">
            ...
            <div className="relative mt-1">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-green-900 cursor-pointer"
              >
